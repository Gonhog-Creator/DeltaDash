...
class Material(Base):
    ...
    elongation_longitudinal_percent = Column(Numeric(10, 2))
    elongation_longitudinal_error_percent = Column(Numeric(10, 2))
    force_longitudinal_newtons = Column(Numeric(10, 2))
    force_longitudinal_error_percent = Column(Numeric(10, 2))
    elongation_transverse_percent = Column(Numeric(10, 2))
    elongation_transverse_error_percent = Column(Numeric(10, 2))
    force_transverse_newtons = Column(Numeric(10, 2))
    force_transverse_error_percent = Column(Numeric(10, 2))
    stretch_test_length = Column(String(10))
